...
class ROUTER_uscongress(Container):
    ...
    def bill_text(
        ...
        **kwargs
        ...
        --------
        >>> from openbb import obb
        >>> obb.uscongress.bill_text(urls='['https://www.congress.gov/119/bills/hr1/BILLS-119hr1eh.pdf']')
    ...
    def bill_text_urls(
        ...
        bill_url: Annotated[
            ...
            OpenBBField(
                description=(
                    'The base URL of the bill (e.g., "https://api.congr'
                    'ess.gov/v3/bill/119/s/1947?format=json"). This can'
                    'also be a shortened version like "119/s/1947".'
                )
            ),
        ],
        is_workspace: Annotated[
            ...
            OpenBBField(
                description=(
                    "Whether the request is coming from the OpenBB"
                    "Workspace. This alters the output format to"
                    "conform to the Workspace's expectations."
                )
            ),
        ] = False,
        provider: Annotated[
            Optional[str],
            OpenBBField(description=('The provider name, always "congress_gov". This is' "a dummy parameter.")),
        ] = "congress_gov",
        **kwargs: Any
    ) -> list:
        ...
        **kwargs
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={
                    "congress": {"congress_gov": {"x-widget_config": {"type": "number"}}},
                    "bill_type": {
                        "congress_gov": {
                            "x-widget_config": {
                                "options": [
                    ...
                    "sort_by": {"congress_gov": {"choices": ["asc", "desc"]}},
                },
            ),
        )
