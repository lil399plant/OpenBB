"""Autogenerated OpenBB /econometrics Module."""
...
class ROUTER_econometrics(Container):
    ...
    def autocorrelation(
        ...
        data: Annotated[
            ...
            OpenBBField(description="Input dataset."),
        ],
        y_column: Annotated[str, OpenBBField(description="Target column.")],
        x_columns: Annotated[list[str], OpenBBField(description="list of columns to use as exogenous variables.")],
        **kwargs: Any
    ) -> OBBject:
    ...
    def causality(
        ...
        y_column: Annotated[str, OpenBBField(description="Target column.")],
        x_column: Annotated[str, OpenBBField(description="Columns to use as exogenous variables.")],
        lag: Annotated[int, OpenBBField(description="Number of lags to use in the test.")] = 3,
        **kwargs: Any
    ) -> OBBject:
    ...
    def cointegration(
        ...
        columns: Annotated[list[str], OpenBBField(description="Data columns to check cointegration")],
        **kwargs: Any
    ) -> OBBject:
    ...
    def correlation_matrix(
        ...
        method: Annotated[
            ...
            OpenBBField(
                description=(
                    "Method to use for correlation calculation. Default"
                    'is "pearson". pearson : standard correlation'
                    "coefficient kendall : Kendall Tau correlation"
                    "coefficient spearman : Spearman rank correlation"
                )
            ),
        ] = "pearson",
        chart: Annotated[
    ...
    def residual_autocorrelation(
        ...
        y_column: Annotated[str, OpenBBField(description="Target column.")],
        x_columns: Annotated[list[str], OpenBBField(description="list of columns to use as exogenous variables.")],
        lags: Annotated[int, OpenBBField(description="Number of lags to use in the test.")] = 1,
        **kwargs: Any
    ) -> OBBject:
    ...
    def unit_root(
        ...
        column: Annotated[str, OpenBBField(description="Data columns to check unit root")],
        regression: Annotated[
            Literal["c", "ct", "ctt"],
            OpenBBField(
                description=(
                    'Regression type to use in the test.  Either "c"'
                    'for constant only, "ct" for constant and trend, or'
    ...
    def variance_inflation_factor(
        ...
        columns: Annotated[
            list[str] | None, OpenBBField(description="The columns to calculate to test for collinearity")
        ] = None,
        **kwargs: Any
    ) -> OBBject:
