"""Autogenerated OpenBB /quantitative/performance Module."""
...
class ROUTER_quantitative_performance(Container):
    ...
    def omega_ratio(
        ...
        threshold_start: Annotated[float, OpenBBField(description="Start threshold, by default 0.0")] = 0.0,
        threshold_end: Annotated[float, OpenBBField(description="End threshold, by default 1.5")] = 1.5,
        **kwargs: Any
    ) -> OBBject:
    ...
    def sharpe_ratio(
        ...
        target: Annotated[str, OpenBBField(description="Target column name.")],
        rfr: Annotated[float, OpenBBField(description="Risk-free rate, by default 0.0")] = 0.0,
        window: Annotated[int, OpenBBField(description="Window size, by default 252")] = 252,
    ...
    def sortino_ratio(
        ...
        target: Annotated[str, OpenBBField(description="Target column name.")],
        target_return: Annotated[float, OpenBBField(description="Target return, by default 0.0")] = 0.0,
        window: Annotated[int, OpenBBField(description="Window size, by default 252")] = 252,
        adjusted: Annotated[
            bool, OpenBBField(description=("Adjust sortino ratio to compare it to sharpe" "ratio, by default False"))
        ] = False,
        index: Annotated[str, OpenBBField(description="Index column for input data")] = "date",
        **kwargs: Any
    ) -> OBBject:
