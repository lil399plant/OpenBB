...
class ROUTER_fixedincome_corporate(Container):
    ...
    def bond_prices(
        self,
        country: Annotated[str | None, OpenBBField(description="The country to get data. Matches partial name.")] = None,
        issuer_name: Annotated[
            str | None,
            OpenBBField(description=("Name of the issuer.  Returns partial matches and" "is case insensitive.")),
        ] = None,
        isin: Annotated[
            Union[list, str, None, list[list | str | None]],
            OpenBBField(
                description=(
                    "International Securities Identification Number(s)"
                    "of the bond(s). Multiple comma separated items"
                    "allowed for provider(s): tmx."
                )
            ),
        ] = None,
        lei: Annotated[str | None, OpenBBField(description="Legal Entity Identifier of the issuing entity.")] = None,
        currency: Annotated[
            list | str | None,
            OpenBBField(
        ...
        coupon_min: Annotated[float | None, OpenBBField(description="Minimum coupon rate of the bond.")] = None,
        coupon_max: Annotated[float | None, OpenBBField(description="Maximum coupon rate of the bond.")] = None,
        issued_amount_min: Annotated[int | None, OpenBBField(description="Minimum issued amount of the bond.")] = None,
        issued_amount_max: Annotated[str | None, OpenBBField(description="Maximum issued amount of the bond.")] = None,
        maturity_date_min: Annotated[
            datetime.date | None, OpenBBField(description="Minimum maturity date of the bond.")
        ] = None,
        maturity_date_max: Annotated[
            datetime.date | None, OpenBBField(description="Maximum maturity date of the bond.")
        ] = None,
        provider: Annotated[
        ...
        **kwargs
        ...
        isin : list | str | list[list | None] | None
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={"isin": {"tmx": {"multiple_items_allowed": True, "choices": None}}},
            )
        )
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                info={
                    ...
                    "yield_curve": {"fred": {"choices": ["spot", "par"]}},
                },
            )
        )
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                info={
                    ...
                    "category": {"fred": {"multiple_items_allowed": True, "choices": ["par_yield", "spot_rate"]}},
                },
            )
        )
