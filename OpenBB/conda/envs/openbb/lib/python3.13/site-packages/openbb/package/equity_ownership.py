...
class ROUTER_equity_ownership(Container):
    ...
    def government_trades(
        ...
        limit: Annotated[int | None, OpenBBField(description="The number of data entries to return.")] = None,
        provider: Annotated[
    ...
    def insider_trading(
        ...
        limit: Annotated[int | None, OpenBBField(description="The number of data entries to return.")] = None,
        provider: Annotated[
            Optional[Literal["fmp", "sec", "tmx"]],
            OpenBBField(
                description=(
                    "The provider to use, by default None. If None, the"
                    "priority list configured in the settings is used."
                    "Default priority: fmp, sec, tmx."
                )
            ),
        ] = None,
        **kwargs
        ...
        ----------
        provider : str
            The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: fmp, sec, tmx.
        symbol : str
        ...
        end_date : date | None
            End date of the data, in YYYY-MM-DD format. Default is today. (provider: sec)
        use_cache : bool
        ...
        company_name : str | None
            Name of the company. (provider: sec)
        form : str | int | None
            Form type. (provider: sec)
        director : bool | None
            Whether the owner is a director. (provider: sec)
        officer : bool | None
            Whether the owner is an officer. (provider: sec)
        ten_percent_owner : bool | None
            Whether the owner is a 10% owner. (provider: sec)
        other : bool | None
                ...
                info={
                    "transaction_type": {
                        "fmp": {
                            "x-widget_config": {
                                "options": [
                                    {"label": "A-Award", "value": "award"},
                                    {"label": "C-Conversion", "value": "conversion"},
                                    {"label": "D-Return", "value": "return"},
                                    {"label": "E-ExpireShort", "value": "expire_short"},
                                    {"label": "F-InKind", "value": "in_kind"},
                                    {"label": "G-Gift", "value": "gift"},
                                    {"label": "H-ExpireLong", "value": "expire_long"},
                                    {"label": "I-Discretionary", "value": "discretionary"},
                                    {"label": "J-Other", "value": "other"},
                                    {"label": "L-Small", "value": "small"},
                                    {"label": "M-Exempt", "value": "exempt"},
                                    {"label": "O-OutOfTheMoney", "value": "otm"},
                                    {"label": "P-Purchase", "value": "purchase"},
                                    {"label": "S-Sale", "value": "sale"},
                                    {"label": "U-Tender", "value": "tender"},
                                    {"label": "W-Will", "value": "will"},
                                    {"label": "X-InTheMoney", "value": "itm"},
                                    {"label": "Z-Trust", "value": "trust"},
                                ]
                            }
                        }
                    }
