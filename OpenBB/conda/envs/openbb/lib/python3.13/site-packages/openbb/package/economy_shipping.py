                        ...
                        "imf": {
                            ...
                            "x-widget_config": {
                                "options": [
                                    ...
                                    {"label": "Bosporus Strait", "value": "chokepoint3"},
                                    {"label": "Bab El-Mandeb Strait", "value": "chokepoint4"},
                                    {"label": "Malacca Strait", "value": "chokepoint5"},
                                    {"label": "Strait Of Hormuz", "value": "chokepoint6"},
                                    {"label": "Cape Of Good Hope", "value": "chokepoint7"},
                                    {"label": "Gibraltar Strait", "value": "chokepoint8"},
                                    {"label": "Dover Strait", "value": "chokepoint9"},
                                    {"label": "Oresund Strait", "value": "chokepoint10"},
                                    {"label": "Taiwan Strait", "value": "chokepoint11"},
                                    {"label": "Korea Strait", "value": "chokepoint12"},
                                    {"label": "Tsugaru Strait", "value": "chokepoint13"},
                                    ...
                                    {"label": "Makassar Strait", "value": "chokepoint20"},
                                    {"label": "Magellan Strait", "value": "chokepoint21"},
                                    {"label": "Yucatan Channel", "value": "chokepoint22"},
                                    {"label": "Windward Passage", "value": "chokepoint23"},
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                info={
                        ...
                        "imf": {
                            "x-widget_config": {
                                "options": [
                                    ...
                                    {"label": "St. Vincent and the Grenadines", "value": "VCT"},
                    ...
                    "port_code": {"imf": {"x-widget_config": {"description": "Dummy parameter for widget grouping."}}},
                },
            )
        )
                ...
                info={
                    ...
                    "port_code": {
                        "imf": {
                            ...
                            "choices": None,
                            "x-widget_config": {
                                "optionsEndpoint": "/api/v1/imf_utils/list_port_id_choices",
                                "style": {"popupWidth": 350},
                            },
                        }
                    },
