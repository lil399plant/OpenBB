...
class ROUTER_currency_price(Container):
    ...
    def historical(
        ...
        symbol: Annotated[
            ...
            OpenBBField(
                description=(
                    ...
                    "allowed for provider(s): fmp, yfinance."
                )
            ),
        ],
        ...
        **kwargs
        ...
        symbol : str | list[str]
            Symbol to get data for. Can use CURR1-CURR2 or CURR1CURR2 format. Multiple comma separated items allowed for provider(s): fmp, yfinance.
        start_date : date | str | None
            Start date of the data, in YYYY-MM-DD format.
        end_date : date | str | None
            End date of the data, in YYYY-MM-DD format.
        interval : str
            Time interval of the data to return. (provider: fmp, yfinance)
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                info={
                    ...
                    "interval": {
                        "fmp": {"choices": ["1m", "5m", "1h", "1d"]},
                        "yfinance": {
                            "multiple_items_allowed": False,
                            "choices": ["1m", "2m", "5m", "15m", "30m", "60m", "90m", "1h", "1d", "5d", "1W", "1M", "1Q"],
                        },
                    },
                },
            )
