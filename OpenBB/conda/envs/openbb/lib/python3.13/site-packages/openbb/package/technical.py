"""Autogenerated OpenBB /technical Module."""
...
class ROUTER_technical(Container):
    ...
    def ad(
        self,
        data: Annotated[
            Union[list, dict, DataFrame, list["DataFrame"], Series, list["Series"], ndarray, Data, list[Data]],
            OpenBBField(description="list of data to be used for the calculation."),
        ],
        index: Annotated[
            str, OpenBBField(description=("Index column name to use with `data`, by default" '"date".'))
        ] = "date",
        offset: Annotated[int, OpenBBField(description="Offset of the AD, by default 0.")] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def adosc(
        ...
        fast: Annotated[
            int, OpenBBField(description=("Number of periods to be used for the fast" "calculation, by default 3."))
        ] = 3,
        slow: Annotated[
            int, OpenBBField(description=("Number of periods to be used for the slow" "calculation, by default 10."))
        ] = 10,
        offset: Annotated[int, OpenBBField(description=("Offset to be used for the calculation, by default" "0."))] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def adx(
        ...
        length: Annotated[int, OpenBBField(description="Number of periods for the ADX, by default 50.")] = 50,
        scalar: Annotated[float, OpenBBField(description="Scalar value for the ADX, by default 100.0.")] = 100.0,
        drift: Annotated[int, OpenBBField(description="Drift value for the ADX, by default 1.")] = 1,
        chart: Annotated[
    ...
    def aroon(
        ...
        length: Annotated[
            int, OpenBBField(description=("Number of periods to be used for the calculation," "by default 25."))
        ] = 25,
        scalar: Annotated[
            float, OpenBBField(description=("Scalar to be used for the calculation, by default" "100."))
        ] = 100,
        chart: Annotated[
            bool, OpenBBField(description=("Whether to create a chart or not, by default" "False."))
        ] = False,
    ...
    def atr(
        ...
        data: Annotated[
            Union[list, dict, DataFrame, list["DataFrame"], Series, list["Series"], ndarray, Data, list[Data]],
            OpenBBField(description="list of data to apply the indicator to."),
        ],
        index: Annotated[str, OpenBBField(description='Index column name, by default "date"')] = "date",
        length: Annotated[int, OpenBBField(description="It's period, by default 14")] = 14,
        mamode: Annotated[
            Literal["rma", "ema", "sma", "wma"], OpenBBField(description='Moving average mode, by default "rma"')
        ] = "rma",
        drift: Annotated[int, OpenBBField(description="The difference period, by default 1")] = 1,
        offset: Annotated[int, OpenBBField(description=("How many periods to offset the result, by default" "0"))] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def bbands(
        ...
        target: Annotated[str, OpenBBField(description="Target column name.")] = "close",
        index: Annotated[
            str, OpenBBField(description=("Index column name to use with `data`, by default" '"date".'))
        ] = "date",
        length: Annotated[
            int, OpenBBField(description=("Number of periods to be used for the calculation," "by default 50."))
        ] = 50,
        std: Annotated[
            float, OpenBBField(description=("Standard deviation to be used for the calculation," "by default 2."))
        ] = 2,
        mamode: Annotated[
            Literal["sma", "ema", "wma", "rma"],
            OpenBBField(description=("Moving average mode to be used for the" 'calculation, by default "sma".')),
        ] = "sma",
        offset: Annotated[int, OpenBBField(description=("Offset to be used for the calculation, by default" "0."))] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def cci(
        ...
        data: Annotated[
            Union[list, dict, DataFrame, list["DataFrame"], Series, list["Series"], ndarray, Data, list[Data]],
            OpenBBField(description="The data to use for the CCI calculation."),
        ],
        index: Annotated[
            str, OpenBBField(description=("Index column name to use with `data`, by default" '"date".'))
        ] = "date",
        length: Annotated[int, OpenBBField(description="The length of the CCI, by default 14.")] = 14,
        scalar: Annotated[float, OpenBBField(description="The scalar of the CCI, by default 0.015.")] = 0.015,
        **kwargs: Any
    ) -> OBBject:
    ...
    def cg(
        ...
        data: Annotated[
            Union[list, dict, DataFrame, list["DataFrame"], Series, list["Series"], ndarray, Data, list[Data]],
            OpenBBField(description="The data to use for the COG calculation."),
        ],
        index: Annotated[
            str, OpenBBField(description=("Index column name to use with `data`, by default" '"date"'))
        ] = "date",
        length: Annotated[int, OpenBBField(description="The length of the COG, by default 14")] = 14,
        **kwargs: Any
    ) -> OBBject:
    ...
    def clenow(
        ...
        target: Annotated[str, OpenBBField(description='Target column name, by default "close".')] = "close",
        period: Annotated[int, OpenBBField(description="Number of periods for the momentum, by default 90.")] = 90,
        **kwargs: Any
    ) -> OBBject:
    ...
    def cones(
        ...
        data: Annotated[
            Union[list, dict, DataFrame, list["DataFrame"], Series, list["Series"], ndarray, Data, list[Data]],
            OpenBBField(description="The data to use for the calculation."),
        ],
        index: Annotated[
            str, OpenBBField(description=("Index column name to use with `data`, by default" '"date"'))
        ] = "date",
        lower_q: Annotated[float, OpenBBField(description="The lower quantile value for calculations")] = 0.25,
        upper_q: Annotated[float, OpenBBField(description="The upper quantile value for calculations")] = 0.75,
        model: Annotated[
            ...
            OpenBBField(
                description=(
                    ...
                    "Standard deviation measures how widely returns are"
                    "dispersed from the average return. It is the most"
                    "common (and biased) estimator of volatility."
                    "Parkinson volatility uses the high and low price"
                    "of the day rather than just close to close prices."
                    "It is useful for capturing large price movements"
                    "during the day. Garman-Klass volatility extends"
                    "Parkinson volatility by taking into account the"
                    "opening and closing price. As markets are most"
                    "active during the opening and closing of a trading"
                    "session; it makes volatility estimation more"
                    "accurate. Hodges-Tompkins volatility is a bias"
                    "correction for estimation using an overlapping"
                    "data sample. It produces unbiased estimates and a"
                    "substantial gain in efficiency. Rogers-Satchell is"
                    "an estimator for measuring the volatility with an"
                    "average return not equal to zero. Unlike Parkinson"
                    "and Garman-Klass estimators, Rogers-Satchell"
                    "incorporates a drift term, mean return not equal"
                    "to zero. Yang-Zhang volatility is the combination"
                    "of the overnight (close-to-open volatility). It is"
                    "a weighted average of the Rogers-Satchell"
                    "volatility and the open-to-close volatility."
                )
            ),
        ] = "std",
        is_crypto: Annotated[
        ...
        trading_periods: Annotated[int | None, OpenBBField(description="Number of trading periods in a year.")] = None,
        chart: Annotated[
            bool, OpenBBField(description=("Whether to create a chart or not, by default" "False."))
        ] = False,
        **kwargs: Any
    ...
    def demark(
        ...
        target: Annotated[str, OpenBBField(description='Target column name, by default "close".')] = "close",
        show_all: Annotated[bool, OpenBBField(description="Show 1 - 13. If set to False, show 6 - 9")] = True,
        asint: Annotated[
            bool, OpenBBField(description=("If True, fill NAs with 0 and change type to int," "by default True."))
        ] = True,
        offset: Annotated[int, OpenBBField(description="How many periods to offset the result")] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def donchian(
        ...
        lower_length: Annotated[
            int, OpenBBField(description=("Number of periods for the lower band, by default" "20."))
        ] = 20,
        upper_length: Annotated[
            int, OpenBBField(description=("Number of periods for the upper band, by default" "20."))
        ] = 20,
        offset: Annotated[int, OpenBBField(description="Offset of the Donchian Channel, by default 0.")] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def ema(
        ...
        length: Annotated[int, OpenBBField(description="The length of the calculation, by default 50.")] = 50,
        offset: Annotated[int, OpenBBField(description="The offset of the calculation, by default 0.")] = 0,
        chart: Annotated[
            bool, OpenBBField(description=("Whether to create a chart or not, by default" "False."))
        ] = False,
        **kwargs: Any
    ...
    def fib(
        ...
        period: Annotated[int, OpenBBField(description="Period to calculate the indicator, by default 120")] = 120,
    ...
    def fisher(
        ...
        index: Annotated[str, OpenBBField(description='Index column name, by default "date"')] = "date",
        length: Annotated[int, OpenBBField(description="Fisher period, by default 14")] = 14,
        signal: Annotated[int, OpenBBField(description="Fisher Signal period, by default 1")] = 1,
        **kwargs: Any
    ) -> OBBject:
    ...
    def hma(
        ...
        length: Annotated[int, OpenBBField(description="Number of periods for the HMA, by default 50.")] = 50,
        offset: Annotated[int, OpenBBField(description="Offset of the HMA, by default 0.")] = 0,
        chart: Annotated[
            bool, OpenBBField(description=("Whether to create a chart or not, by default" "False."))
        ] = False,
        **kwargs: Any
    ...
    def ichimoku(
        ...
        conversion: Annotated[
            int, OpenBBField(description=("Number of periods for the conversion line, by" "default 9."))
        ] = 9,
        base: Annotated[int, OpenBBField(description=("Number of periods for the base line, by default" "26."))] = 26,
        lagging: Annotated[
            int, OpenBBField(description=("Number of periods for the lagging span, by default" "52."))
        ] = 52,
        offset: Annotated[int, OpenBBField(description="Number of periods for the offset, by default 26.")] = 26,
        lookahead: Annotated[
            bool, OpenBBField(description=("drops the Chikou Span Column to prevent potential" "data leak"))
        ] = False,
        **kwargs: Any
    ) -> OBBject:
    ...
    def kc(
        ...
        data: Annotated[
            Union[list, dict, DataFrame, list["DataFrame"], Series, list["Series"], ndarray, Data, list[Data]],
            OpenBBField(description=("The data to use for the Keltner Channels" "calculation.")),
        ],
        index: Annotated[
            str, OpenBBField(description=("Index column name to use with `data`, by default" '"date"'))
        ] = "date",
        length: Annotated[int, OpenBBField(description="The length of the Keltner Channels, by default 20")] = 20,
        scalar: Annotated[
            float, OpenBBField(description=("The scalar to use for the Keltner Channels, by" "default 20"))
        ] = 20,
        mamode: Annotated[
            Literal["ema", "sma", "wma", "hma", "zlma"],
            OpenBBField(description=("The moving average mode to use for the Keltner" 'Channels, by default "ema"')),
        ] = "ema",
        offset: Annotated[
            int, OpenBBField(description=("The offset to use for the Keltner Channels, by" "default 0"))
        ] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def macd(
        ...
        target: Annotated[str, OpenBBField(description="Target column name.")] = "close",
        index: Annotated[str, OpenBBField(description="")] = "date",
        fast: Annotated[int, OpenBBField(description="Number of periods for the fast EMA, by default 12.")] = 12,
        slow: Annotated[int, OpenBBField(description="Number of periods for the slow EMA, by default 26.")] = 26,
        signal: Annotated[int, OpenBBField(description=("Number of periods for the signal EMA, by default" "9."))] = 9,
        chart: Annotated[
            bool, OpenBBField(description=("Whether to create a chart or not, by default" "False."))
        ] = False,
        **kwargs: Any
    ...
    def relative_rotation(
        ...
        data: Annotated[
            ...
            OpenBBField(
                description=(
                    "The data to be used for the relative rotation"
                    "calculations. This should be the multi-symbol"
                    "output from the 'equity.price.historical'"
                    "endpoint, or similar. Or a pivot table with the"
                    "'date' column as the index, the symbols as the"
                    "columns, and the 'study' as the values. It is"
                    "recommended to use the 'equity.price.historical'"
                    "endpoint to get the data, and feed the results as-"
                    "is."
                )
            ),
        ],
        benchmark: Annotated[str, OpenBBField(description="The symbol to be used as the benchmark.")],
        study: Annotated[
            Literal["price", "volume", "volatility"],
            OpenBBField(
                description=(
                    "The data point for the calculations. If 'price',"
                    "the closing price will be used. If 'volatility',"
                    "the standard deviation of the closing price will"
                    "be used. If 'data' is supplied as a pivot table,"
                    "the 'study' will assume the values are the closing"
                    "price and 'volume' will be ignored."
                )
            ),
        ] = "price",
        long_period: Annotated[
            int | None,
            OpenBBField(
                description=(
                    "The length of the long period for momentum"
                    "calculation, by default 252. Adjust this value"
                    "when supplying a time series with an interval that"
                    "is not daily. For example, if the data is monthly,"
                    "the long period should be 12."
                )
            ),
        ] = 252,
        short_period: Annotated[
            int | None,
            OpenBBField(
                description=(
                    "The length of the short period for momentum"
                    "calculation, by default 21. Adjust this value when"
                    "supplying a time series with an interval that is"
                    "not daily."
                )
            ),
        ] = 21,
        window: Annotated[
            ...
            OpenBBField(
                description=(
                    "The length of window for the standard deviation"
                    "calculation, by default 21. Adjust this value when"
                    "supplying a time series with an interval that is"
                    "not daily."
                )
        ...
        trading_periods: Annotated[
            int | None,
            OpenBBField(
                description=(
                    "The number of trading periods per year, for the"
                    "standard deviation calculation, by default 252."
                    "Adjust this value when supplying a time series"
                    "with an interval that is not daily."
                )
            ),
        ] = 252,
        chart_params: Annotated[
            ...
            OpenBBField(
                description=(
                    "Additional parameters to pass when `chart=True`"
                    "and the `openbb-charting` extension is installed."
                    "Parameters can be passed again to redraw the chart"
                    "using the charting.to_chart() method of the"
                    "response. ChartParams -----------"
                )
            ),
        ] = None,
        chart: Annotated[
    ...
    def rsi(
        ...
        data: Annotated[
            Union[list, dict, DataFrame, list["DataFrame"], Series, list["Series"], ndarray, Data, list[Data]],
            OpenBBField(description="The data to use for the RSI calculation."),
        ],
        target: Annotated[str, OpenBBField(description="Target column name.")] = "close",
        index: Annotated[
            str, OpenBBField(description=("Index column name to use with `data`, by default" '"date"'))
        ] = "date",
        length: Annotated[int, OpenBBField(description="The length of the RSI, by default 14")] = 14,
        scalar: Annotated[float, OpenBBField(description="The scalar to use for the RSI, by default 100.0")] = 100.0,
        drift: Annotated[int, OpenBBField(description="The drift to use for the RSI, by default 1")] = 1,
        chart: Annotated[
            bool, OpenBBField(description=("Whether to create a chart or not, by default" "False."))
        ] = False,
        **kwargs: Any
    ...
    def sma(
        ...
        offset: Annotated[int, OpenBBField(description="Offset from the current period, by default 0.")] = 0,
        chart: Annotated[
            bool, OpenBBField(description=("Whether to create a chart or not, by default" "False."))
        ] = False,
        **kwargs: Any
    ...
    def stoch(
        ...
        data: Annotated[
            Union[list, dict, DataFrame, list["DataFrame"], Series, list["Series"], ndarray, Data, list[Data]],
            OpenBBField(description=("The data to use for the Stochastic Oscillator" "calculation.")),
        ],
        index: Annotated[
            str, OpenBBField(description=("Index column name to use with `data`, by default" '"date".'))
        ] = "date",
        fast_k_period: Annotated[int, OpenBBField(description="The fast %K period, by default 14.")] = 14,
        slow_d_period: Annotated[int, OpenBBField(description="The slow %D period, by default 3.")] = 3,
        slow_k_period: Annotated[int, OpenBBField(description="The slow %K period, by default 3.")] = 3,
        **kwargs: Any
    ) -> OBBject:
    ...
    def vwap(
        ...
        anchor: Annotated[
            ...
            OpenBBField(
                description=(
                    "Anchor period to use for the calculation, by"
                    'default "D". See Timeseries Offset Aliases below'
    ...
    def wma(
        ...
        length: Annotated[int, OpenBBField(description="The length of the WMA, by default 50.")] = 50,
        offset: Annotated[int, OpenBBField(description="The offset of the WMA, by default 0.")] = 0,
        chart: Annotated[
            bool, OpenBBField(description=("Whether to create a chart or not, by default" "False."))
        ] = False,
        **kwargs: Any
