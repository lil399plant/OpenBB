...
class ROUTER_imf_utils(Container):
    ...
    def get_dataflow_dimensions(
        ...
        dataflow_id: Annotated[
            str, OpenBBField(description=("The IMF dataflow ID. Use `list_dataflows()` to see" "available dataflows."))
        ],
        output_format: Annotated[Literal["json", "markdown"], OpenBBField(description="")] = "json",
        **kwargs: Any
    ) -> OBBject:
    ...
    @exception_handler
    @validate
    def list_dataflow_choices(self, **kwargs: Any) -> list:
    ...
    @validate
    def list_dataflows(
        self, output_format: Annotated[Literal["json", "markdown"], OpenBBField(description="")] = "json", **kwargs: Any
    ) -> OBBject:
    ...
    @exception_handler
    @validate
    def list_port_id_choices(self, **kwargs: Any) -> list:
    ...
    @exception_handler
    @validate
    def list_table_choices(self, **kwargs: Any) -> list:
    ...
    @exception_handler
    @validate
    def list_tables(self, **kwargs: Any) -> OBBject:
    ...
    def presentation_table(
        ...
        dataflow_group: Annotated[
            str | None,
            OpenBBField(description=("The IMF dataflow group. See" "presentation_table_choices() for options.")),
        ] = None,
        table: Annotated[
            str | None,
            OpenBBField(description=("The IMF presentation table ID. See" "presentation_table_choices() for options.")),
        ] = None,
        country: Annotated[
            str | None,
            OpenBBField(
        ...
        limit: Annotated[int, OpenBBField(description="Maximum number of records to retrieve per series.")] = 1,
        raw: Annotated[bool, OpenBBField(description=("Return presentation table as raw JSON data if" "True."))] = False,
        **kwargs: Any
    ) -> Any:
    ...
    def presentation_table_choices(
        self,
        dataflow_group: Annotated[
            str | None, OpenBBField(description="The IMF dataflow group. Show all groups if None.")
        ] = None,
        table: Annotated[
            str | None,
            OpenBBField(description=("The IMF presentation table ID. Enter a" "dataflow_group to see table choices.")),
        ] = None,
        country: Annotated[
            str | None, OpenBBField(description=("Enter a dataflow_group and table to see country" "choices."))
        ] = None,
        frequency: Annotated[
            str | None,
            OpenBBField(description=("Enter a dataflow_group, table, and country to see" "frequency choices.")),
        ] = None,
        **kwargs: Any
    ) -> list:
        """Get presentation table choices for IMF data retrieval.
