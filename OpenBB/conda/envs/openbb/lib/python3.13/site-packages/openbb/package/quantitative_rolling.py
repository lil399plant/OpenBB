"""Autogenerated OpenBB /quantitative/rolling Module."""
...
class ROUTER_quantitative_rolling(Container):
    ...
    def kurtosis(
        ...
        data: Annotated[
            ...
            OpenBBField(description="The time series data as a list of data points."),
        ],
        target: Annotated[str, OpenBBField(description=("The name of the column for which to calculate" "kurtosis."))],
        window: Annotated[
            int, OpenBBField(description=("The number of observations used for calculating" "the rolling measure."))
        ] = 21,
        index: Annotated[str, OpenBBField(description='The name of the index column, default is "date".')] = "date",
        **kwargs: Any
    ) -> OBBject:
    ...
    def mean(
        ...
        target: Annotated[str, OpenBBField(description=("The name of the column for which to calculate the" "mean."))],
        window: Annotated[
            int, OpenBBField(description=("The number of observations used for calculating" "the rolling measure."))
        ] = 21,
        index: Annotated[str, OpenBBField(description='The name of the index column, default is "date".')] = "date",
    ...
    def quantile(
        ...
        target: Annotated[
            str, OpenBBField(description=("The name of the column for which to calculate the" "quantile."))
        ],
        window: Annotated[
            int, OpenBBField(description=("The number of observations used for calculating" "the rolling measure."))
        ] = 21,
        quantile_pct: Annotated[
            float,
            OpenBBField(description=("The quantile percentage to calculate (e.g., 0.5" "for median), default is 0.5.")),
        ] = 0.5,
        index: Annotated[str, OpenBBField(description='The name of the index column, default is "date".')] = "date",
        **kwargs: Any
    ) -> OBBject:
    ...
    def skew(
        ...
        data: Annotated[
            Union[list, dict, DataFrame, list["DataFrame"], Series, list["Series"], ndarray, Data, list[Data]],
            OpenBBField(description="Time series data."),
        ],
        target: Annotated[str, OpenBBField(description="Target column name.")],
        window: Annotated[int, OpenBBField(description="Window size.")] = 21,
    ...
    def stdev(
        ...
        target: Annotated[
            str, OpenBBField(description=("The name of the column for which to calculate" "standard deviation."))
        ],
        window: Annotated[
            int, OpenBBField(description=("The number of observations used for calculating" "the rolling measure."))
        ] = 21,
    ...
    def variance(
        ...
        target: Annotated[str, OpenBBField(description=("The name of the column for which to calculate" "variance."))],
        window: Annotated[
            int, OpenBBField(description=("The number of observations used for calculating" "the rolling measure."))
        ] = 21,
        index: Annotated[str, OpenBBField(description='The name of the index column, default is "date".')] = "date",
