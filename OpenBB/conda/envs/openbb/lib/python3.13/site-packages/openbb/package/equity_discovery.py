        ...
        provider: Annotated[
            ...
            OpenBBField(
                description=(
                    "The provider to use, by default None. If None, the"
                    "priority list configured in the settings is used."
                    "Default priority: fmp, tmx, yfinance."
                )
            ),
        ] = None,
        **kwargs
        ...
        ----------
        provider : str
            The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: fmp, tmx, yfinance.
        sort : str
            Sort order. Possible values: 'asc', 'desc'. Default: 'desc'.
        category : str
            The category of list to retrieve. Defaults to `price_performer`. (provider: tmx)
            Choices for tmx: 'dividend', 'energy', 'healthcare', 'industrials', 'price_performer' 'rising_stars', 'real_estate', 'tech', 'utilities', '52w_high', 'volume'
        limit : int | None
            Limit the number of results. (provider: yfinance)
        ...
        exchange : str | None
            Stock exchange where the security is listed. (provider: fmp);
            Exchange where the stock is listed. (provider: yfinance)
        thirty_day_price_change : float | None
            30 Day Price Change. (provider: tmx)
        ninety_day_price_change : float | None
