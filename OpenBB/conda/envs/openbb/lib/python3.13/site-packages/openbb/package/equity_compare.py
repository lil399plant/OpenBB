        ...
        fact: Annotated[
            ...
            OpenBBField(
                description=(
                    ...
                    "rShareAmount', 'Assets', 'AssetsCurrent',"
                    ...
                    "'CommitmentsAndContingencies', 'CommercialPaper',"
                    "'CommonStockDividendsPerShareDeclared',"
                    "'CommonStockDividendsPerShareCashPaid',"
                    "'CommonStocksIncludingAdditionalPaidInCapital',"
                    ...
                    "'DerivativeNotionalAmount', 'Dividends',"
                    "'DividendsCash', 'DividendsPayableAmountPerShare',"
                    "'DividendsPayableCurrent', 'DistributedEarnings',"
                    "'EarningsPerShareBasic',"
                    ...
                    "rrangements', 'InterestExpenseDebt',"
                    "'InterestIncomeExpenseNet', 'InterestPaid',"
                    "'InterestPaidNet', 'InventoryNet',"
                    ...
                    "'NonoperatingIncomeExpense', 'NoninterestIncome',"
                    ...
                    "'PaymentsForCapitalImprovements',"
                    "'PaymentsOfDividends',"
                    "'PaymentsOfDividendsMinorityInterest', 'PaymentsFo"
                    "rProceedsFromBusinessesAndInterestInAffiliates',"
                    "'PaymentsForProceedsFromOtherInvestingActivities',"
                    "'PaymentsForRent',"
                    "'PaymentsForRepurchaseOfCommonStock',"
                    "'PaymentsOfDebtExtinguishmentCosts',"
                    ...
                    "'RetainedEarningsAccumulatedDeficit', 'Revenues',"
                    "'RevenueFromContractWithCustomerExcludingAssessedT"
                    "ax', 'SecuredLongTermDebt',"
                    "'SellingAndMarketingExpense',"
                    "'SellingGeneralAndAdministrativeExpense',"
                    "'ShareBasedCompensation', 'ShortTermBorrowings',"
                    "'ShortTermInvestments', 'StockholdersEquity', 'Sto"
                    "ckholdersEquityIncludingPortionAttributableToNonco"
                    "ntrollingInterest', 'StockholdersEquityOther',"
                    "'StockIssuedDuringPeriodValueNewIssues',"
                    "'StockOptionPlanExpense',"
                    "'StockRedeemedOrCalledDuringPeriodValue',"
                    "'StockRepurchasedDuringPeriodValue',"
                    ...
                    "'WeightedAverageNumberOfDilutedSharesOutstanding',"
                    "'WeightedAverageNumberOfSharesOutstandingBasic', '"
                    "WeightedAverageNumberDilutedSharesOutstandingAdjus"
                    "tment'"
                )
            ),
        ] = "",
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                info={
                    ...
                    "fiscal_period": {
                        "sec": {"multiple_items_allowed": False, "choices": ["fy", "q1", "q2", "q3", "q4"]}
                    },
                },
            )
        )
    ...
    def groups(
        ...
        **kwargs
        ...
        group : str
            ...
            Choices for finviz: 'capitalization', 'communication_services', 'consumer_cyclical' 'consumer_defensive', 'country', 'energy', 'financial', 'healthcare' 'industrials', 'industry', 'materials', 'real_estate', 'sector', 'technology' 'utilities'
        metric : str
            Statistical metric to return. Select from: ['performance', 'valuation', 'overview'] The default is 'performance'. (provider: finviz)
            Choices for finviz: 'performance', 'valuation', 'overview'
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                info={
                    ...
                    "metric": {
                        "finviz": {"multiple_items_allowed": False, "choices": ["performance", "valuation", "overview"]}
                    },
                },
            )
        )
