...
class ROUTER_fixedincome_rate(Container):
        ...
        **kwargs
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={"parameter": {"fred": {"choices": ["daily_excl_weekend", "monthly", "weekly", "daily", "annual"]}}},
            )
        )
    ...
    def ecb(
        ...
        interest_rate_type: Annotated[
            Literal["deposit", "lending", "refinancing"], OpenBBField(description="The type of interest rate.")
        ] = "lending",
        provider: Annotated[
            Optional[Literal["fred"]],
            OpenBBField(
