"""Autogenerated OpenBB /quantitative Module."""
...
class ROUTER_quantitative(Container):
    ...
    def performance(self):
        """Router for /quantitative/performance."""
    ...
    @property
    def rolling(self):
        """Router for /quantitative/rolling."""
    ...
    def unitroot_test(
        ...
        fuller_reg: Annotated[
            Literal["c", "ct", "ctt", "nc"], OpenBBField(description="Regression type for ADF test.")
        ] = "c",
        kpss_reg: Annotated[Literal["c", "ct"], OpenBBField(description="Regression type for KPSS test.")] = "c",
        **kwargs: Any
    ) -> OBBject:
        """Get Unit Root Test.
