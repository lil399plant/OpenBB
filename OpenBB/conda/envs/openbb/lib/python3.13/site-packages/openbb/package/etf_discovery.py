"""Autogenerated OpenBB /etf/discovery Module."""
...
class ROUTER_etf_discovery(Container):
    ...
    def active(
        ...
        **kwargs
        ...
        formatted_volume : str | None
            Formatted volume. (provider: wsj)
        formatted_price_change : str | None
            Formatted price change. (provider: wsj)
        formatted_percent_change : str | None
